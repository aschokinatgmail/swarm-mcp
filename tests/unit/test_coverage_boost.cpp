...
protected:
    ...
    void SetUp() override {
        test_repo_path = std::filesystem::temp_directory_path().string() + "/swarm-mcp-branch-cov";
        std::error_code ec;
...
protected:
    ...
    void SetUp() override {
        test_repo_path = std::filesystem::temp_directory_path().string() + "/swarm-mcp-merge-cov";
        std::error_code ec;
        std::filesystem::remove_all(test_repo_path, ec);
        std::filesystem::create_directories(test_repo_path);
        std::filesystem::current_path(test_repo_path);
